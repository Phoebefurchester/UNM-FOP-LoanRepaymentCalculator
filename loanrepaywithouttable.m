...
% Last Modified by GUIDE v2.5 02-Apr-2021 15:25:08
...
%ROW 1
    ...
    set(handles.beginningbal1,'string',beginningbal);

    payment=handles.monthly_payment;
    set(handles.payment,'string',payment);

    interest=handles.yearly_interest/100*beginningbal;
    set(handles.interestrow1,'string',interest);


    principal=handles.monthly_payment-interest;
    set(handles.principalrow1,'string',principal);


    endingbal=beginningbal-principal;
    set(handles.endingbalrow1,'string',endingbal);
...
%while e~=0 
        ...
        row4=[row3;a,b,c,d,e];
        row5=row4;
        outputrow1=num2cell(row5);
        set(handles.outputtable,'Data',outputrow1);
        
   
%end

%ROW 2
%beginningbal2=endingbal;
%set(handles.beginningbal2,'string',beginningbal2);
%payment same
%payment=handles.monthly_payment;
%set(handles.payment,'string',payment);
%second interest depends on second beginning balance

%interestrow2=handles.yearly_interest/100*beginningbal2;
%set(handles.interestrow2,'string',interestrow2);

%second principal depends on second interest
%principal2=handles.monthly_payment-interestrow2;
%set(handles.principalrow2,'string',principal2);

%ending balance 2 depends on both
%endingbal2=beginningbal2-principal2;
%set(handles.endingbalrow2,'string',endingbal2);
